...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		var timeText;
		var titleHtml;
		var imgHtml;			//updated by vajesh for adding image
		var searchDtl;
		var SessionKey;
		...
		imgHtml		  = '<span class="fc-title"><img style="height:15px;"src="' +event.img +'" /></span>'; //updated by vajesh for adding image
		searchDtl	  = event.key;
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content"  onclick="expand_cal('+"'"+searchDtl+"'"+",'"+SessionKey+"'"+');">' +
					(this.isRTL ?
						titleHtml + ' ' + timeHtml +' '+imgHtml: // put a natural space in between  //updated by vajesh for adding image
						timeHtml + ' ' + titleHtml +' '+imgHtml  //updated by vajesh for adding image
						) +
				'</div>' +
...
TimeGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content"  onclick="expand_cal();">' +
					(timeText ?
						'<div class="fc-time"' +
