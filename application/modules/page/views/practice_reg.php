	...
	<div id="container_demo" >
		...
		<div id="wrapper">
			<div id="login" class="animate form" style="border:1px solid #ddd; border-radius:4px;">
				<!--<form  action="mysuperscript.php" autocomplete="on"> -->
				<form  action="<?php echo base_url(); ?>page/login/practice-reg" autocomplete="on" method="POST" id="login_form"> 
					<h1>Log in as Practice / Hospital</h1> 
					<p> 
			...
			<div id="register" class="animate form" style="border:1px solid #ddd; border-radius:4px;">
				<form  action="#" autocomplete="on" method="POST" id="register_form"> 
				<!--<form  action="mysuperscript.php" autocomplete="on"> -->
					<h1> Sign up as Practice / Hospital</h1>    
					<div class="row">    
					...
					<div class="row">    
						<div class="col-md-6 col-sm-6 col-xs-12 form-group mb5 clearfix "> 
							<label for="emailsignup" class="youmail"  > Practice / Hospital Name</label>
							<input id="HospitalName" name="HospitalName" required="required" type="text" placeholder="Practice / Hospital Name"/> 
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12 form-group mb5 clearfix "> 
					...
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-12 form-group mb5 clearfix "> 
							<label for="passwordsignup_confirm" class="youpasswd" >Country</label>
							...
							?>
							<input type="hidden" name="UserType" value="<?php echo $this->config->item('medical_practice'); ?>" /> 
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12 form-group mb5 clearfix "> 
	...
	<li class="list-group-item"><span class="fa fa-hand-o-right"></span> Muliple Booking options</li>
	...
	<script src="<?php echo base_url(); ?>assets/js/practice-reg.js"></script>	