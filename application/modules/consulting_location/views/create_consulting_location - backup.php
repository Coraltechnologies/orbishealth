                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                           <img src="<?php echo base_url(); ?>assets/img/profile-image.png" alt="Profile" class="img-circle profile_img">
                        </div>
                ...
                <div class="nav_menu">
                    <nav>
                        ...
                        <div class="nav-title" style="margin: 10px auto 5px;">
                            <h1><?php if(isset($details) && !empty($details)){echo "Edit";}else{echo "Add";} ?> Consulting Location </h1>
                        </div>

                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="<?php echo base_url(); ?>assets/img/profile-image.png" alt="">Dr. John Doe
																	...
																	<div class="col-md-12 col-sm-12 col-xs-12">
																		<table class="table table-striped" id="mytb">
																			<thead style="background: #f5f5f5; color: #000;">
																				<tr>
																					<th width="10%"><h5><b>Weeks</b></h5></th>
																					<th width="25%"><h5><b>Open / Close</b></h5></th>
																					<th width="10%"><h5 style="text-align:center;"><b>24/7 </b></h5></th>
																					<th width="10%" colspan="2" style="background: #ccc;"><h5 style="text-align:center;"><b><i class="fa fa-coffee" aria-hidden="true"></i> Morning</b></h5></th>
																					<th width="10%" colspan="2" style="background: #b3b3b3;"><h5 style="text-align:center;"><b><i class="fa fa-sun-o" aria-hidden="true"></i> Afternoon</b></h5></th>
																					<th width="10%" colspan="2" style="background: #ccc;"><h5 style="text-align:center;"><b><i class="fa fa-moon-o" aria-hidden="true"></i> Evening</b></h5></th>
																				</tr>
																			</thead>
																			<tbody>
																				<tr>
                                                                                    ...
                                                                                    <tbody id="upload_doc_exist_list" style="height: 10px !important; overflow: scroll; ">
																						<?php
																							if(!empty($documents)) {
																								...
																								if($i == 0){
																									echo "<tr><td colspan='4'>No records uploaded</td></tr>";
																								}
																								}else{
																									echo "<tr><td colspan='4'>No records uploaded</td></tr>";
																								}
