                                        ...
                                        <div class="panel-body">
											...
											<div>
                                                <div class="col-md-12 col-sm-6 col-xs-12 padding-null consuting-rooms" id="consulting_list_<?php echo $d_val['id']; ?>">
                                                    <div id="consuting-rooms"   class="x_panel table-responsive">
																						...
																						<div class="row">
																							<div class="col-md-1 col-sm-12 col-xs-12">
																								<div class="profile__header">
																									<?php
																										if($u_val['img_path'] && $u_val['img_name']){
																										?>
																											<img src="<?php echo base_url()."assets/uploads/".$u_val['img_path'].'/'.$u_val['img_name'] ?>" alt='<?php echo  $u_val['name'] ?>' style="height:50px;width:50px;border-radius:50px;">
																										<?php
																										}else{
																										?>
																											<img src="<?php echo base_url(); ?>assets/img/profile-image.png" alt="<?php echo  $u_val['name'] ?>" style="height:50px;width:50px;border-radius:50px;">
																										<?php
																										}
																									?>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 table-responsive" style="font-size: 12px;">
                                                <table class="table table-striped table-bordered">
                                                    <thead>

                                                        <tr style="background-color: #146068;color: #fff;">
                                                            <th>Weeks</th>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <div class="x_panel mc_x_panel">
                                                    <div class="x_title mc_heading-bg">
                                                        <h2 class="mc_heading">Services</h2>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <div class="col-md-12">
													<?php
                                            ...
                                            <div class="preview col-md-3 col-sm-6 col-xs-12">
												<div class="x_panel ">
													<div class="x_title ">
														<h2 class="">Photo's & Videos</h2>
