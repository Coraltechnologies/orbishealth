                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3 col-sm-6 col-xs-12 form-text-wrapper">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input id="ageId" type="text" class="form-control" placeholder="age" disabled='disabled' value="<?php echo $diff.' yrs'; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3 col-sm-6 col-xs-6 form-text-wrapper">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="+123 4567 890" id="home_mobile" value="<?php if($details['home_telephone']){echo $details['home_telephone'];} ?>" onkeypress="return restrict_keys(event)">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 col-sm-6 col-xs-6 form-text-wrapper">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="col-md-4 col-sm-12 col-xs-12 form-text-wrapper">
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input type="checkbox" class="form-check-input" id="cbxMinorImportAddress" onchange="fill_address(this,'minor_address')" <?php if($details['address'] && isset($patient_minor['address']) && $patient_minor['address'] == $details['address']){echo "checked";} ?>>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="col-md-6 col-sm-12 col-xs-12 form-text-wrapper">
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="checkbox" class="form-check-input" id="cbxMinorImportAddress" onchange="fill_address(this,'next_address')" <?php if(isset($details['address']) && isset($patient_nxt['address']) && $patient_nxt['address'] == $details['address']){echo "checked";} ?>>
                                                                    <label class="form-check-label" for="exampleCheck1">Import home address</label>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div id="menu8" class="tab-pane fade">
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="actionBar">
										...
										<a href="<?php echo base_url()."account_setup/patients_summary"; ?>" class="buttonNext btn btn-success"> <i class="fa fa-floppy-o" aria-hidden="true"></i> Save and Continue</a>
                                    </div>
                                </div>
                            </div>
                        </div>
	...
	if($consent){
		...
		function save_demography(){
			...
			if(ethinic_id == ''){
				...
				var url								= "<?php echo base_url(); ?>account_setup/update_details";
				var form_data 			= new FormData();
		...
		function save_notes(){
			...
			if(notes.trim() != ''){
				var form_data 								= new FormData();
				var url										= "<?php echo base_url(); ?>account_setup/save_notes";
		...
		function save_consent(){
			...
			if($("#accept_terms").prop('checked')){
				var url											= "<?php echo base_url(); ?>account_setup/save_consent";
...
*/
	...
	function delete_alert(a){
		...
		var url				= "<?php echo base_url(); ?>account_setup/remove_notes";
		if(stat == true){
			$.post(url,{a:a,type:'alert'},function(response){
	...
	function delete_note(a){
		...
		var url				= "<?php echo base_url(); ?>account_setup/remove_notes";
		if(stat == true){
			$.post(url,{a:a,type:'notes'},function(response){
				if(response.response.trim() == 'success'){
					$("#note_row_"+a).remove();
					if($("#notes_tbody").html() == ''){
	...
	function update_alert(){
		...
		var url				= "<?php echo base_url(); ?>account_setup/update_notes";
		$.post(url,{txt_alert : txt_alert,txt_id:txt_id,type:'alert'},function(response){
	...
	function update_notes(){
		...
		var url				= "<?php echo base_url(); ?>account_setup/update_notes";
		$.post(url,{txt_alert : txt_alert,txt_id:txt_id,type:'notes'},function(response){
			//console.log(response);
			if(response.response.trim()=='success'){
