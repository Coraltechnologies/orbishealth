                                                ...
                                                <div class="col-md-9 col-sm-12 col-xs-12" style="margin-top:20px;">
                                                    ...
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <p class="summary_view_text"><?php if($user_details['firstname']){ echo $user_details['firstname'];} ?></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label>Middle Name</label>
                                                            <p class="summary_view_text"><?php if($user_details['middlename']){ echo $user_details['middlename'];} ?></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label>Last Name</label>
                                                            <p class="summary_view_text"><?php if($user_details['lastname']){ echo $user_details['lastname'];} ?></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 col-sm-12 col-xs-12">
                                                        <label>Gender</label>
                                                        <p class="summary_view_text"><?php if($user_details['gender']){ echo $user_details['gender'];} ?></p>
                                                    </div>

                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <label>NHS No</label>
                                                            <p class="summary_view_text"><?php if($user_details['nhs_no']){ echo $user_details['nhs_no'];} ?></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        <div class="">
                                                            <div class="xdisplay_inputx form-group has-feedback">
                                                                <label>DOB</label>
                                                                <p class="summary_view_text"><?php if($user_details['dob']){ echo date('d/m/Y',strtotime($user_details['dob']));} ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-md-8 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <p class="summary_view_text">
																<?php
																	if($user_details['country_id']){echo $country['name'][$user_details['country_id']];}
																?>
															</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <p class="summary_view_text">
																<?php
																	if($user_details['postcode']){echo $user_details['postcode'];}
																?>
															</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <p class="summary_view_text">
																<?php
																	if($user_details['city_town']){echo $user_details['city_town'];}
																?>
															</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="col-md-3 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="summary_view_text">
															<?php
																if($user_details['home_telephone']){echo $user_details['home_telephone'];}
															?>
														</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="summary_view_text">
															<?php
																if($user_details['work_telephone']){echo $user_details['work_telephone'];}
															?>
														</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="summary_view_text">
														<?php
															if($user_details['mobile']){echo $user_details['mobile'];}
														?>
														</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="summary_view_text">
															<?php
																if($user_details['primary_email']){echo $user_details['primary_email'];}
															?>
														</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <p class="summary_view_text"><?php if($user_details['ethinic_origin']){echo $ethinic_details[$user_details['ethinic_origin']];} ?></p>
                                                </div>
                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="summary_view_text">
															<?php
															if(trim($user_details['languages'])	!= ''){
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="summary_view_text"><?php if($user_details['marital_status']){echo $marital_list[$user_details['marital_status']];} ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
