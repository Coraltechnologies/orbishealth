                ...
                <form class="form-horizontal form-label-left row custom_temp">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>
                                    ID 0012 &nbsp;&nbsp;&nbsp; Registration - Start: <?php echo date('d/m/Y',strtotime($user_details['user_start_date'])); ?> &nbsp;&nbsp;&nbsp; <span style="background: #229e78; color:#fff; padding: 1px 5px;" class="pull-right">
                                        <i class="fa fa-check-square"></i> Active
                                    </span>
                                </h2>
                                <ul class="nav navbar-right panel_toolbox">
                                    <li> <a href="<?php echo base_url(); ?>account_setup" type="button" class="btn btn-md btn-success" style="padding: 6px 10px;"> Edit </a></li>
                                                            ...
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div class="panel-body">
																	...
																	foreach ($medical_bodies as $m_key => $m_val){
                                                                        ...
                                                                        <p>Expiry Date : <?php if($val_r['expiry_date']){echo date('d/m/Y',strtotime($val_r['expiry_date']));} ?></p>
                                                                    </div>
																	<?php
																	}
																	?>
																		...
																		<div class="row">
																			...
																			<div class="col-md-2 col-sm-12 col-xs-12">
																				<div class="form-group">
																					<label>Country</label>
																					<p class="summary_view_text">
																						<?php echo $country['name'][$file_values['country_id']] ?>
																					</p>
																				</div>
																			</div>
																			<div class="col-md-2 col-sm-12 col-xs-12">
																				<div class="form-group">
																					...
																					<p class="summary_view_text">
																						<?php 
																							if($file_values['show_public'] == 1){
																								echo 'Public';
																							}else if($file_values['show_public'] ==0){
																								echo 'Private';
																							}
																						?>
																					</p>
