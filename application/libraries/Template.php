...
class Template {
	...
	/***************************************************************
	/* RENDER CONTENT
	/* Updated by Cary Buchmann. (cjbuchmann)
	/* For use with GToolsV2. 
	/* Aug 23, 2011
	/*
	/* @access 	public
	/* @param	string	view file to use
	/* @param	array	variables to pass into view
	/* @param	boolean	FALSE to append to region, TRUE to overwrite region
	/* @return  void or content string
	/**************************************************************/
   function render_content($view, $data = NULL, $overwrite = FALSE)
   {
		$this->write_view('content', $view, $data, $overwrite);
