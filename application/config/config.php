...
|
*/
$config['base_url'] = 'http://localhost/OrbisHealth';
...
$config['sess_save_path'] = sys_get_temp_dir(); //updated by vajesh(21-03-2018)
...
$config['professional']         ='1';
$config['medical_practice']     ='2';
$config['patient']              ='3';

$config['ico_id']               ='1';
$config['indemnity_id']         ='2';
$config['uk_country_code']      ='204';


$config['clinical']             ='1';
$config['non-clinical']         ='2';
$config['both']                 ='3';
...
$config['default_mail']         = 'admin@orbishealth.com';
$config['default_mail_name']    = 'Orbis Health Team';
